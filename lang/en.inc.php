...
$messages['changemessage'] = "Hello {login},\n\nYour password has been changed.\n\nIf you didn't request a password reset, please contact the fsi admins at fsi-admin@fsi.uni-tuebingen.de immediately.";
...
$messages['policypwned'] = "Your new password may not be published on any previous public password leak from any site (this will be automatically checked with the HaveIBeenPwned API)";
