...
$messages['login'] = "Login (fsi-Account)";
...
$messages['changemessage'] = "Hallo {login},\n\nIhr Passwort wurde geändert.\n\nWenn Sie dies nicht selbst veranlasst haben, melden Sie dies bitte umgehend den fsi Admins fsi-admin@fsi.uni-tuebingen.de.\n\n";
...
$messages['policydifflogin'] = "Ihr neues Passwort darf nicht dasselbe wie Ihr Loginname sein";
...
$messages['policypwned'] = "Ihr neues Passwort darf in keinem Passwortleak von anderen Webseiten enthalten sein. (wird automatisch mit HaveIBeenPwned überprüft)"; 
